  ...
  return (
    <div className="w-full min-h-full flex flex-1 flex-col justify-center md:py-40 dark:text-white">
      ...
      <form
        ...
        className="sm:mx-auto sm:w-full sm:max-w-md sm:border-2 rounded-lg p-4 dark:bg-white dark:bg-opacity-5"
      >
        ...
        <section>
          ...
          {loader ? (
            ...
            <button
              type="submit"
              className="w-full bg-green-900 text-white font-bold rounded-md p-2 my-2"
            >
              Submit
            </button>
          )}
